...
x_train['Gender'] = label_encoder.fit_transform(x_train['Gender'].values)
x_test['Gender'] = label_encoder.transform(x_test['Gender'].values)
...
print(x_test.shape)
input_species = loaded_encoder.transform(np.expand_dims("Female",-1))
print(int(input_species))
inputs = np.expand_dims([int(input_species),1],0)
print(inputs.shape)
